...
from .serializers import (
    PetSerializer,
PetSerializerWithDescription)
# Create your views here.


#Clase donde retorna todas las mascotas en la base de datos y retorna la petición en formato Json
class ListPets(ListAPIView):
    serializer_class = PetSerializer
    def get_queryset(self):
        return Pet.objects.all()

#Clase para filtrar mascotas Requerimiento 6
